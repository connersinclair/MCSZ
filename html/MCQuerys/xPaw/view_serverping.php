<?php
	...
	// Edit this ->
	define( 'MQ_SERVER_ADDR', 'Play.BrutalFactions.Us' );
	define( 'MQ_SERVER_PORT', null );
	define( 'MQ_TIMEOUT', 1 );
	// Edit this <-
...
<?php if( isset( $Exception ) ): ?>
		<div class="panel panel-primary">
			...
			<p><?= nl2br( $e->getTraceAsString(), false ); ?></p>
		</div>
<?php else: ?>
		<div class="row">
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th colspan="2">Server Info <em>(queried in <?= $Timer; ?>s)</em></th>
						</tr>
					</thead>
					<tbody>
<?php if( $Info !== false ): ?>
